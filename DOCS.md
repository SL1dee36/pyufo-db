# Документация по базе данных PY-UFO-DB

Оригинальная c++ версия проекта: [UFO-DB](https://github.com/atxxxm/UFO-DB)

Эта документация описывает структуру и использование базы данных PY-UFO-DB, реализованной на Python. База данных позволяет хранить и управлять записями о наблюдениях PY-UFO-DB, организованными в таблицы.

## Классы

### `UFORecords`

Этот класс представляет собой отдельную запись о PY-UFO-DB.
